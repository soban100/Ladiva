...
export const HomeLiving = () => {
  ...
  const filteredAndSortedProducts = homeProducts
    .filter(product =>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-2xl font-bold text-gray-900">Home & Living</h1>
              <span className="text-sm text-gray-500">({homeProducts.length} products)</span>
            </div>
          </div>
        </div>
      </div>
